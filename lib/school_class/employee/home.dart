...
class Employeeome extends StatefulWidget {
  UserModel user;

  Employeeome({super.key,required this.user});

  @override
  State<Employeeome> createState() => _EmployeeomeState();
}

class _EmployeeomeState extends State<Employeeome> {
  int visit = 0;
