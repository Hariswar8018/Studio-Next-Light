      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              r(w,""),  r(w,"Monday"),  r(w,"Tuesday"),  r(w,"Wednesday"),  r(w,"Thursday"),  r(w,"Friday"),  r(w,"Saturday"),
            ],
          ),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              r(w,"1st"),  r(w,widget.user.m1),   r(w,widget.user.t1), r(w,widget.user.w1), r(w,widget.user.th1), r(w,widget.user.fr1), r(w,widget.user.s1),
            ],
          ),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              r(w,"2st"),  r(w,widget.user.m2),   r(w,widget.user.t2), r(w,widget.user.w2), r(w,widget.user.th2), r(w,widget.user.fr2), r(w,widget.user.s2),
            ],
          ),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              r(w,"3st"),  r(w,widget.user.m3),   r(w,widget.user.t3), r(w,widget.user.w3), r(w,widget.user.th3), r(w,widget.user.fr3), r(w,widget.user.s3),
            ],
          ),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              r(w,"4st"),  r(w,widget.user.m4),   r(w,widget.user.t4), r(w,widget.user.w4), r(w,widget.user.th4), r(w,widget.user.fr4), r(w,widget.user.s4),
            ],
          ),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              r(w,"5st"),  r(w,widget.user.m5),   r(w,widget.user.t5), r(w,widget.user.w5), r(w,widget.user.th5), r(w,widget.user.fr5), r(w,widget.user.s5),
            ],
          ),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              r(w,"6st"),  r(w,widget.user.m6),   r(w,widget.user.t6), r(w,widget.user.w6), r(w,widget.user.th6), r(w,widget.user.fr6), r(w,widget.user.s6),
            ],
          ),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              r(w,"7st"),  r(w,widget.user.m7),   r(w,widget.user.t7), r(w,widget.user.w7), r(w,widget.user.th7), r(w,widget.user.fr7), r(w,widget.user.s7),
            ],
          ),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              r(w,"8st"),  r(w,widget.user.m8),   r(w,widget.user.t8), r(w,widget.user.w8), r(w,widget.user.th8), r(w,widget.user.fr8), r(w,widget.user.s8),
            ],
          ),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              r(w,"9st"),  r(w,widget.user.m9),   r(w,widget.user.t9), r(w,widget.user.w9), r(w,widget.user.th9), r(w,widget.user.fr9), r(w,widget.user.s9),
            ],
          ),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              r(w,"10st"),  r(w,widget.user.m10),   r(w,widget.user.t10), r(w,widget.user.w10), r(w,widget.user.th10), r(w,widget.user.fr10), r(w,widget.user.s10),
            ],
          ),
        ],
      ),
  ...
  Widget r(double w,String gh) {
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Text(gh, style: TextStyle(fontSize: 8, color: Colors.white),),
      ),
    );
  }
}
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      persistentFooterButtons: [
        InkWell(
          onTap: () async {
            String hy=DateTime.now().millisecondsSinceEpoch.toString();
            Timetable j=Timetable(id: hy, s1: s1Controller.text, s2: s2Controller.text, s3: s3Controller.text, s4: s4Controller.text,
                ...
                fr7: fr7Controller.text, fr8: fr8Controller.text, fr9: fr9Controller.text, fr10: fr10Controller.text);
           try{
