...
class _LoginScreenState extends State<HScreen> {
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Center(child: Text("Check & Modify Student Data", style: TextStyle( color : Colors.black,fontFamily: "font1", fontSize: 17, fontWeight: FontWeight.w400))),
                SizedBox(height: 30,),
                Image.asset("assets/parent.gif"),
                SizedBox(height: 30,),
                TextFormField(
                  controller: _emailController,
                  keyboardType: TextInputType.emailAddress,
                  decoration: InputDecoration(
                    labelText: 'Student Id card no',  isDense: true,
                ...
                TextFormField(
                  ...
                  obscureText: true,
                  decoration: InputDecoration(
                    labelText: 'Student Unique Id', isDense: true,
                    border: OutlineInputBorder(),
                  ),
                  validator: (value) {
                    if (value!.isEmpty) {
