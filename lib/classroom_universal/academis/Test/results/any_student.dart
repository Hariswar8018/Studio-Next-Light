...
class StudentAnyResult extends StatelessWidget {
  StudentAnyResult({super.key,required this.student,required this.id,required this.session_id,required this.class_id,required this.admin});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        automaticallyImplyLeading: admin,
        backgroundColor: Colors.blue,
        title: Text("${student.Name} Result",style: TextStyle(color: Colors.white),),
      ),
      body: StreamBuilder(
        stream: FirebaseFirestore.instance
            ...
            .collection("Class")
            .doc(class_id)
            .collection("Student").doc(student.Registration_number).collection("Results")
            .snapshots(),
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text("No Results",style: TextStyle(fontSize: 20,fontWeight: FontWeight.w800),),
                    ...
                    return InkWell(
                      onTap: (){
                        Navigator.push(
                            context,
                            PageTransition(
                                child:StUser(student: student, users: users,),
                                    ...
                                    leading: CircleAvatar(
                                      ...
                                      child: Center(
                                        child: CircleAvatar(
                                          ...
                                          child:Center(child: Text(users.totalmarks,style: TextStyle(fontSize: 8,fontWeight: FontWeight.w800),)),
                                        ),
                                      ),
                                    ),
                                    title:  Text(users.title,style: TextStyle(fontWeight: FontWeight.w900,fontSize: 16),),
                                    subtitle: Text("Happened from ${a(users.startdate)} to ${a(users.enddate)}",style: TextStyle(fontSize: 8),),
                                  ),
                                  Padding(
                                    padding: const EdgeInsets.only(left: 15,right: 15),
                                    child: Text("Total Mark : "+users.syllabus,style: TextStyle(fontWeight: FontWeight.w400,fontSize: 16),),
                                  ),
                                  Padding(
                                    padding: const EdgeInsets.only(left: 15,right: 15),
                                    child: Text("Test Type : "+(users.exam?"Exam":"Test"),style: TextStyle(fontWeight: FontWeight.w400,fontSize: 16),),
                                  ),
                                ],
                              ),
                            ),
  ...
  String a(String dateTimeString) {
    try {
...
class StUser extends StatelessWidget {
   StUser({super.key,required this.users,required this.student});
  TestModel users;StudentModel student;
  @override
  Widget build(BuildContext context) {
    double w = MediaQuery.of(context).size.width;
    return Scaffold(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text("Users Test",style: TextStyle(fontSize: 12,fontWeight: FontWeight.w100),),
              SizedBox(height: 9,),
